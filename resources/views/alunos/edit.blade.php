    ...
    <div class="container">
        ...
        <form action="{{ route('alunos.update', $aluno->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" name="data_de_nascimento" id="data_de_nascimento" value="{{ old('data_de_nascimento', $aluno->data_de_nascimento) }}" class="form-control">
            </div>
            <div class="form-group">
                <label for="curso">Curso:</label>
                <input type="text" name="curso" id="curso" value="{{ old('curso', $aluno->curso) }}" class="form-control">
            </div>
